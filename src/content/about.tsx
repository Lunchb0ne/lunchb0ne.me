  ...
  paragraphs: [
    {
      ...
      content: (
        <>
          ...
          failovers, backups, security, all the <span className="text-white/90 italic">invisible machinery</span> that makes “it
    ...
    },
    {
      ...
      content: (
        <>
          My bias is toward <span className="font-medium text-white italic">simple, ruthless designs</span>. No ceremony, no
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <span className="font-medium text-pink-400">open source experiments</span> that push databases until they complain and
