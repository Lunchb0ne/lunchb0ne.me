...
export const TAGLINES = [
  "DISTRIBUTED SYSTEMS, LESS DRAMA",
  "KEEPING DATABASES CALM IN CHAOS",
  "CLOUD SCALE, HUMAN EXPLANATIONS",
  "HIGH AVAILABILITY, LOW EGO",
  "DEBUGGING THE INVISIBLE STUFF",
  "OPEN SOURCE, OCCASIONAL CHAOS",
  "SYSTEMS THAT FAIL GRACEFULLY (MOSTLY)",
];
