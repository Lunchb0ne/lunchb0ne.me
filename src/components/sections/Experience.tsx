  ...
  <>
    ...
    <div className="space-y-12">
      {EXPERIENCE_ITEMS.map((exp) => (
        ...
        >
          <div className="absolute top-2 -left-1.25 h-2.5 w-2.5 rounded-full border border-white/30 bg-[#050505] transition-all duration-300 group-hover:border-cyan-400 group-hover:bg-cyan-400 group-hover:shadow-[0_0_10px_rgba(34,211,238,0.5)]" />
